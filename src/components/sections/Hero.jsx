        ...
        <div className="hero-content">
          <div className="badge-wrapper">
            <span className="hero-badge">
              <span className="bullet"></span> El "CFO de Bolsillo" para
              Microempresas
            </span>
          </div>
          <h1>
            El motor financiero y publicitario que{" "}
            <span className="text-gradient-ai">
              da vida a tu stock estancado
            </span>
          </h1>
          <p className="hero-subtext">
            AdNova.ai integra <strong>diagnóstico financiero contable</strong>,{" "}
            <strong>escaneo inteligente de facturas (OCR)</strong> y{" "}
            <strong>creación de afiches con IA</strong> in un solo entorno.
            Recupera el capital inmovilizado en tu almacén y mide tu retorno
            publicitario (ROAS) real a través de WhatsApp.
          </p>
          ...
          <div className="hero-dashboard-mockup">
            <div className="mockup-header">
              ...
              <span className="mockup-title">
                AdNova.ai — Mapeo de Capital de Trabajo
              </span>
            </div>
            <div className="mockup-body">
              ...
              <div className="mockup-list">
                <div className="mockup-item warning">
                  ...
                  <span className="m-badge badge-warning">
                    Pérdida: $1,394 USD
                  </span>
                </div>
                <div className="mockup-item danger">
                  ...
                  <span className="m-badge badge-danger">
                    Pérdida: $6,375 USD
                  </span>
                </div>
              </div>
              <div className="mockup-footer">
                <div className="ai-status">
                  ...
                  <span>
                    Recomendación: Generar campaña de recuperación de capital
                    con 35% de descuento.
                  </span>
                </div>
              </div>
